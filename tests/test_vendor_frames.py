...
# Exercise the actual shutdown arm serialization without the real device destructor.
destructor = function('turn_on_robot::~turn_on_robot()')
arm = destructor[destructor.index('  Send_Data.tx[0]=0xAA;'):]
...
print('PASS actual vendor callbacks: short/nonfinite/range rejection, arm length/BCC/shutdown, security tail/BCC (ASan+UBSan)')
