...
#CP2102 串口号0010 设置别名为wheeltec_lidar2
echo  'KERNEL=="ttyUSB*",      ATTRS{idVendor}=="10c4", ATTRS{idProduct}=="ea60",ATTRS{serial}=="0010", MODE:="0777", GROUP:="dialout", SYMLINK+="wheeltec_lidar2"' >/etc/udev/rules.d/wheeltec_lidar4.rules
#CH9102，同时系统安装了对应驱动 串口号0001 设置别名为wheeltec_lidar2
echo  'KERNEL=="ttyCH343USB*", ATTRS{idVendor}=="1a86", ATTRS{idProduct}=="55d4",ATTRS{serial}=="0010", MODE:="0777", GROUP:="dialout", SYMLINK+="wheeltec_lidar2"' >/etc/udev/rules.d/wheeltec_lidar5.rules
#CH9102，同时系统没有安装对应驱动 串口号0001 设置别名为wheeltec_lidar2
echo  'KERNEL=="ttyACM*",      ATTRS{idVendor}=="1a86", ATTRS{idProduct}=="55d4",ATTRS{serial}=="0010", MODE:="0777", GROUP:="dialout", SYMLINK+="wheeltec_lidar2"' >/etc/udev/rules.d/wheeltec_lidar6.rules
...
#添加GNSS设备规则文件 设置别名为wheeltec_gnss
